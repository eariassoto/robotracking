...
\hypertarget{classboton_toggle_abdba9bf27d77ddcd56c83bb494ddebb7}{}\index{boton\+Toggle@{boton\+Toggle}!update@{update}}
\index{update@{update}!boton\+Toggle@{boton\+Toggle}}
\subsubsection[{update(float, float, bool)}]{\setlength{\rightskip}{0pt plus 5cm}bool boton\+Toggle\+::update (
\begin{DoxyParamCaption}
\item[{float}]{x, }
\item[{float}]{y, }
\item[{bool}]{c}
\end{DoxyParamCaption}
)}\label{classboton_toggle_abdba9bf27d77ddcd56c83bb494ddebb7}
...
\begin{DoxyParams}{Parámetros}
{\em x} & coordenada x del componente de gestos \\
\hline
{\em y} & coordenada y del componente de gestos \\
\hline
...
\end{DoxyReturn}
\hypertarget{classboton_toggle_ad7f6623575a6e17544bd9fd9bef18c8a}{}\index{boton\+Toggle@{boton\+Toggle}!update@{update}}
\index{update@{update}!boton\+Toggle@{boton\+Toggle}}
\subsubsection[{update(float, float)}]{\setlength{\rightskip}{0pt plus 5cm}bool boton\+Toggle\+::update (
\begin{DoxyParamCaption}
\item[{float}]{x, }
\item[{float}]{y}
\end{DoxyParamCaption}
)}\label{classboton_toggle_ad7f6623575a6e17544bd9fd9bef18c8a}
...
\begin{DoxyParams}{Parámetros}
{\em x} & coordenada x de la entrada \\
\hline
{\em y} & coordenada y de la entrada\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
true si el usuario hizo clic sobre el componente 
\end{DoxyReturn}
\hypertarget{classboton_toggle_ae0c7f301bb81bf8e813be7273e09ce3d}{}\index{boton\+Toggle@{boton\+Toggle}!update@{update}}
\index{update@{update}!boton\+Toggle@{boton\+Toggle}}
\subsubsection[{update(bool)}]{\setlength{\rightskip}{0pt plus 5cm}bool boton\+Toggle\+::update (
\begin{DoxyParamCaption}
\item[{bool}]{res}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classboton_toggle_ae0c7f301bb81bf8e813be7273e09ce3d}
